...
import io.github.framework.web.jackson.EnumModule;
import io.github.framework.web.jackson.BaseJacksonModule;
...
public class JacksonExtendAutoConfiguration {
    ...
    public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
        builder.simpleDateFormat(BaseConstant.Jackson.DATE_TIME_FORMAT);
        ...
        objectMapper
                ...
                // Date参数日期格式
                .setDateFormat(new SimpleDateFormat(BaseConstant.Jackson.DATE_TIME_FORMAT, defaultLocale))
                ...
                // 自定义序列化/反序列化规则
                .registerModule(new BaseJacksonModule())
