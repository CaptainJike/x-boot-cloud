...
import io.github.framework.core.exception.XBootFrameworkException;
import io.github.framework.core.props.BaseProperties;
import io.github.framework.i18n.util.I18nUtil;
import io.github.framework.web.enums.GlobalWebExceptionI18nMessageEnum;
import io.github.framework.web.model.response.ApiResult;
import io.github.framework.web.util.InvalidFieldUtil;
...
public class GlobalWebExceptionHandlerAutoConfiguration {
    ...
    public ResponseEntity<ApiResult<Void>> handleBusinessException(BusinessException e, HttpServletRequest request) {
         ...
         */
        String msg;
        if (Boolean.TRUE.equals(baseProperties.getI18n().getEnabled()) && e.getCustomEnumField() != null) {
    ...
    @ExceptionHandler({XBootFrameworkException.class})
    public ResponseEntity<ApiResult<Void>> handleXBootFrameworkException(XBootFrameworkException e, HttpServletRequest request) {
        this.logError(e, request);
    ...
    public ResponseEntity<ApiResult<Void>> handleException(Exception e, HttpServletRequest request) {
        ...
        if (e.getClass().getName().startsWith(DUBBO_PACKAGE_PREFIX)) {
            // Dubbo RPC异常
            responseCode = BaseConstant.Dubbo.RPC_EXCEPTION_RESPONSE_CODE;
        }
    ...
    protected void logError(XBootFrameworkException e, HttpServletRequest request) {
        log.error("❗ XBoot framework has internal exception ❗ >> 异常类=[{}], URI=[{}], 消息=[{}]  ",
    ...
    protected String determineI18nMessage(@NonNull GlobalWebExceptionI18nMessageEnum msgEnum) {
        if (Boolean.TRUE.equals(baseProperties.getI18n().getEnabled())) {
