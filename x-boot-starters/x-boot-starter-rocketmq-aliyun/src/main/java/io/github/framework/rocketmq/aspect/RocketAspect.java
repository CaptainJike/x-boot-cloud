...
package io.github.framework.rocketmq.aspect;

import io.github.framework.rocketmq.annotation.CommonMessage;
import io.github.framework.rocketmq.annotation.OrderMessage;
import io.github.framework.rocketmq.annotation.RocketMessage;
import io.github.framework.rocketmq.annotation.TransactionMessage;
import io.github.framework.rocketmq.core.factory.ShardingKeyFactory;
import io.github.framework.rocketmq.core.factory.StartDeliverTimeFactory;
import io.github.framework.rocketmq.core.factory.ThreadPoolFactory;
import io.github.framework.rocketmq.core.utils.AspectUtils;
import io.github.framework.rocketmq.core.utils.InterceptRocket;
...
public class RocketAspect implements ApplicationContextAware {
    ...
    @Pointcut("@annotation(io.github.framework.rocketmq.annotation.CommonMessage)")
    public void commonMessagePointcut() {
        log.debug("Start sending CommonMessage");
    }

    @Pointcut("@annotation(io.github.framework.rocketmq.annotation.OrderMessage)")
    public void orderMessagePointcut() {
        log.debug("Start sending OrderMessage");
    }

    @Pointcut("@annotation(io.github.framework.rocketmq.annotation.TransactionMessage)")
