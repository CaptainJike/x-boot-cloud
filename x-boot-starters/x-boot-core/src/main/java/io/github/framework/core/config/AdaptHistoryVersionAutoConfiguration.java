...
public class AdaptHistoryVersionAutoConfiguration implements EnvironmentAware {
     ...
     * 旧的配置keys
     */
    private static final String[] OLD_PROPERTY_PREFIXES = {"x.crud.tenant."};

    /**
     * 新的配置keys
     */
    private static final String[] NEW_PROPERTY_PREFIXES = {"x.tenant."};
    ...
    /**
     * 将配置文件中所有 [x.crud.tenant.] 开头的配置转移到 [x.tenant.] 下
     * 实践测试 只对 @Value 注解有效
     */
