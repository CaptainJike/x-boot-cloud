...
import io.github.module.sys.enums.SysErrorEnum;
...
import io.github.module.sys.service.SysRoleMenuRelationService;
import io.github.module.sys.service.SysTenantService;
import io.github.module.sys.service.SysUserDeptRelationService;
import io.github.module.sys.service.SysUserRoleRelationService;
...
public class SysUserService {
    ...
    public void postConstruct() {
        this.isTenantEnabled = baseProperties.getTenant().getEnabled();
    }
    ...
    public Long adminInsert(AdminInsertOrUpdateSysUserDTO dto) {
        ...
        entity
                ...
                .setPwd(PwdUtil.encrypt(SecureUtil.md5(SecureUtil.md5(dto.getPasswordOfNewUser())), salt));
